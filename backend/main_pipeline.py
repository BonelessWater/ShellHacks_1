"""Compatibility shim exposing the archived main_pipeline implementation.
This file re-exports symbols from backend.archive.main_pipeline to support
legacy imports used by scripts and tests.
"""
from backend.archive.main_pipeline import *  # noqa: F401,F403
